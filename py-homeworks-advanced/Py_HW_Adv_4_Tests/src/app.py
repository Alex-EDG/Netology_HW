...
def move_doc_to_shelf():
    ...
    # Передаем выводимые данные в return
...
def show_all_docs_info():
    ...
    for current_document in documents:
        print(show_document_info(current_document)) # Данные из return на print
...
def secretary_program_start():
    ...
    while True:
        ...
        if user_command == 'p':
            ...
            print(move_doc_to_shelf()) # Данные из return на print
